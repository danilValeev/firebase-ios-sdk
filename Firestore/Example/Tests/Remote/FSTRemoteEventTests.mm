...
- (void)testDocumentUpdate {
  ...
  FSTDeletedDocument *deletedDoc1 =
      [FSTDeletedDocument documentWithKey:doc1.key version:testutil::Version(3) hasCommittedMutations:NO];
...
- (void)testSynthesizeDeletes {
  ...
  FSTDeletedDocument *expected =
      [FSTDeletedDocument documentWithKey:limboKey version:event.snapshotVersion hasCommittedMutations:NO];
...
- (void)testSeparatesDocumentUpdates {
  ...
  FSTDocument *existingDoc = FSTTestDoc("docs/existing", 1, @{@"some" : @"data"}, FSTDocumentStateSynced);
