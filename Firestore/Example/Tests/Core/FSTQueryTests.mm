...
- (void)testMatchesCorrectlyForShallowAncestorQuery {
  FSTDocument *doc1 = FSTTestDoc("rooms/eros/messages/1", 0, @{@"text" : @"msg1"}, FSTDocumentStateSynced);
  FSTDocument *doc1Meta = FSTTestDoc("rooms/eros/messages/1/meta/1", 0, @{@"meta" : @"mv"}, FSTDocumentStateSynced);
  FSTDocument *doc2 = FSTTestDoc("rooms/eros/messages/2", 0, @{@"text" : @"msg2"}, FSTDocumentStateSynced);
  FSTDocument *doc3 = FSTTestDoc("rooms/other/messages/1", 0, @{@"text" : @"msg3"}, FSTDocumentStateSynced);
...
- (void)testArrayContainsFilter {
  ...
  // array with element.
  doc = FSTTestDoc("collection/1", 0, @{@"array" : @[ @1, @"2", @42, @{@"a" : @1} ]}, FSTDocumentStateSynced);
...
- (void)testArrayContainsFilterWithObjectValue {
  ...
  // array with element.
  doc = FSTTestDoc("collection/1", 0, @{@"array" : @[ @1, @"2", @42, @{@"a" : @[ @42 ]} ]}, FSTDocumentStateSynced);
  XCTAssertTrue([query matchesDocument:doc]);
}
...
- (void)testNullFilter {
  ...
  FSTDocument *doc1 = FSTTestDoc("collection/1", 0, @{@"sort" : [NSNull null]}, FSTDocumentStateSynced);
  FSTDocument *doc2 = FSTTestDoc("collection/2", 0, @{@"sort" : @2}, FSTDocumentStateSynced);
...
- (void)testDoesNotMatchComplexObjectsForFilters {
  ...
  FSTDocument *doc4 = FSTTestDoc("collection/4", 0, @{@"sort" : @{@"foo" : @2}}, FSTDocumentStateSynced);
  FSTDocument *doc5 = FSTTestDoc("collection/5", 0, @{@"sort" : @{@"foo" : @"bar"}}, FSTDocumentStateSynced);
  FSTDocument *doc6 = FSTTestDoc("collection/6", 0, @{@"sort" : @{}}, FSTDocumentStateSynced);  // no sort field
  FSTDocument *doc7 = FSTTestDoc("collection/7", 0, @{@"sort" : @[ @3, @1 ]}, FSTDocumentStateSynced);
...
- (void)testFiltersBasedOnArrayValue {
  ...
  FSTDocument *doc1 = FSTTestDoc("collection/doc", 0, @{@"tags" : @[ @"foo", @1, @YES ]}, FSTDocumentStateSynced);
...
- (void)testFiltersBasedOnObjectValue {
  ...
  FSTDocument *doc1 =
      FSTTestDoc("collection/doc", 0,
                 @{@"tags" : @{@"foo" : @"foo", @"a" : @0, @"b" : @YES, @"c" : @(NAN)}}, FSTDocumentStateSynced);
